window.addEventListener("load", (event) => {
    ...
    placeteam.canvas.addEventListener('mousedown', function(event) {
        ...
        if(event.which == 1){//left click
            ...
            placeteam.changeColor(placeteam.rgbToHex(rgbarray[0],rgbarray[1],rgbarray[2]),placeteam.colors[placeteam.colorcontainer.querySelector('.select .selected').dataset.colorid]);
